...
namespace NumberOfLines
{
    class Program
    {
        ...
        {
            var result = NumberOfLines(
                new [] {10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10},
                "abcdefghijklmnopqrstuvwxyz");

            var result2 = NumberOfLines(
                new[] { 4, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10 },
                "bbbcccdddaa");
        }
